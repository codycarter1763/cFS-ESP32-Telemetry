 ...
 * @file
 *
 * Common definitions for all esp32_bridge_app coverage tests
 */

#ifndef ESP32_BRIDGE_APP_COVERAGETEST_COMMON_H
#define ESP32_BRIDGE_APP_COVERAGETEST_COMMON_H
...
#endif /* ESP32_BRIDGE_APP_COVERAGETEST_COMMON_H */
