...
CFE_Status_t ESP32_BRIDGE_APP_TblValidationFunc(void *TblData)
{
    ...
    ESP32_BRIDGE_APP_ExampleTable_t *TblDataPtr = (ESP32_BRIDGE_APP_ExampleTable_t *)TblData;

    /*
    ** Sample Example Table Validation
    */
    if (TblDataPtr->Int1 > ESP32_BRIDGE_APP_PLATFORM_TBL_ELEMENT_1_MAX)
    {
        /* First element is out of range, return an appropriate error code */
        ReturnCode = ESP32_BRIDGE_APP_PLATFORM_TABLE_OUT_OF_RANGE_ERR_CODE;
    }
