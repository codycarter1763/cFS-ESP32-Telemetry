 ...
 * @file
 *
 * Common definitions for all stm32_bridge_app coverage tests
 */

#ifndef STM32_BRIDGE_APP_COVERAGETEST_COMMON_H
#define STM32_BRIDGE_APP_COVERAGETEST_COMMON_H
...
#endif /* STM32_BRIDGE_APP_COVERAGETEST_COMMON_H */
