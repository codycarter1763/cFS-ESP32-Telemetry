...
CFE_Status_t STM32_BRIDGE_APP_TblValidationFunc(void *TblData)
{
    ...
    STM32_BRIDGE_APP_ExampleTable_t *TblDataPtr = (STM32_BRIDGE_APP_ExampleTable_t *)TblData;

    /*
    ** Sample Example Table Validation
    */
    if (TblDataPtr->Int1 > STM32_BRIDGE_APP_PLATFORM_TBL_ELEMENT_1_MAX)
    {
        /* First element is out of range, return an appropriate error code */
        ReturnCode = STM32_BRIDGE_APP_PLATFORM_TABLE_OUT_OF_RANGE_ERR_CODE;
    }
